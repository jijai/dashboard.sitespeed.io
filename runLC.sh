...
DOCKER_CONTAINER=sitespeedio/sitespeed.io:25.7.2

DOCKER_SETUP="--cap-add=NET_ADMIN --network dashboardsitepeedio_backend --shm-size=2g --rm -v /config:/config -v "$(pwd)":/sitespeed.io -v /etc/localtime:/etc/localtime:ro -e MAX_OLD_SPACE_SIZE=3072 "
